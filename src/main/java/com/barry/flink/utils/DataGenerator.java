...
public class DataGenerator {
    ...
    private static final Instant beginTime = Instant.parse("2020-07-17T12:00:00.00Z");
    ...
    public long driverId() {
        ...
        return 2020000000 + rnd.nextInt(NUMBER_OF_DRIVERS);
    }
