...
public class RuleParserTest {
  ...
  public void testRuleParsedPlain() throws Exception {
    ...
    Assert.assertEquals("Rule state incorrect", Rule.RuleState.ACTIVE, rule1.getRuleState());
    ...
    Assert.assertEquals(
        ...
        Rule.AggregatorFunctionType.SUM,
        rule1.getAggregatorFunctionType());
    Assert.assertEquals(
        "Limit operator incorrect", Rule.LimitOperatorType.GREATER, rule1.getLimitOperatorType());
